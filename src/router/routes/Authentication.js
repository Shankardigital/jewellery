...
const Otp = lazy(() => import('../../views/pages/authentication/Otp'))
const Changepsw = lazy(() => import('../../views/pages/authentication/Changepsw'))
const Testlog = lazy(() => import('../../views/pages/authentication/Testlog'))
