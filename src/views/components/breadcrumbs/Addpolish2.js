...
const Adddrawing = () => {
  ...
  const actiordrs = () => {
    const token = datas
    console.log(token)
    axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/polish2ndstage/getorders",
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  const activecust = () => {
    ...
    const token = datas
    console.log(token)
    axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/polish2ndstage/getemployee",
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  const handleChangewe = (e) => {
    ...
    axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/polish2ndstage/settingitemweight", params,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  const addOrders = () => {
    ...
    console.log(token)
    axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/polish2ndstage/addpolish2ndstage", params,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  return (
    <Fragment>
      <div
        ...
        <BreadCrumbsPage data={[{ title: "Add Polish 2nd Stage" }]} />
            ...
            <Form onSubmit={(e) => { handleSubmit(e) }}>
              <Row className="mb-1">
                ...
                <Col sm="3">
                  ...
                  {/* <select required onChange={ (e) => handleChange(e) } name="purity" className="form-select">
                <option value="">Select</option>
                ...
                <Col sm="3">
                  ...
                  <Input value={itemval} required name="issuedGold" type="text" placeholder="Enter Gold Weight" />
                </Col>
