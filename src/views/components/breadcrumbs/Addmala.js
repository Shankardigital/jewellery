...
const Addsetting = () => {
    ...
    const [itemdates, setitemdate] = useState([])
    ...
    const Addcasting = () => {
        ...
        console.log(token)
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/mala/addmala", params,
            {
                headers: { Authorization: `Bearer ${token}` }
            }, {}
        ).then((res) => {
    ...
    return (
        <Fragment>
            <div
                ...
                <BreadCrumbsPage data={[{ title: "Add Mala" }]} />

                <Card className="mt-1">
                    <CardHeader>
                        <h5>Issued To Mala Details</h5>
                    </CardHeader>
                    <CardBody>
