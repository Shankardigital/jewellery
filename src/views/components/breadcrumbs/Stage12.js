...
const BreadCrumbs = () => {
  ...
  */
  ...
  const actiordrs = () => {
    ...
    axios.post(`http://103.186.185.77:5023/omsanthoshjewellery/admin/mala/getmalabyid`, params,
      ...
      if (res.status === 200) {
        ...
        setordr(res.data.malaFound)
        setordr01(res.data.malaFound.otherDetails)
      }
  ...
  const updateset = () => {
    ...
    console.log(token)
    axios.put(`http://103.186.185.77:5023/omsanthoshjewellery/admin/mala/editmala/${docsetid}`, params,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  return (
    <Fragment>
      <div
        ...
        <BreadCrumbsPage data={[{ title: "Mala Details" }]} />
        {/* <Nav /> */}
        <Card className="mt-1">
          <CardBody>
            <Row>
