...
const Addsetting = () => {
    ...
    const [stpkts, setstpkts] = useState([{ value: "", label: "", itemType: "" }])
    // const [stpkts1, setstpkts1] = useState([])
    ...
    //     { value: data._id, label: data.orderNo, purity: data.itemPurity, itemNames: data.itemNameMulti, itemdat: data.deliveryDate }
    // ))
    ...
    //     console.log(data)
    //     const myUser = { ...selectedMulti2 }
    //     myUser[data.target.name] = data.value
    //     setselectedMulti2(myUser)
    //     inputList[i]['item'] = data.item
    //     const set = [...orders, data]
    ...
    const handleChange12 = (e) => {
        ...
        myUser[e.target.name] = e.target.value
        setform(myUser)
        const count = parseFloat(form.outWeight) + parseFloat(e.target.value)
    ...
    const actiordrs123 = () => {
        ...
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/setting/getsettingbyid", params,
            ...
            if (res.status === 200) {
                ...
                // setselectedMulti(res.data.settingResult.orderNo)
                // setordritem(res.data.)asd
    ...
    const Addcasting = () => {
        ...
        console.log(token)
        axios.put(`http://103.186.185.77:5023/omsanthoshjewellery/admin/setting/editissuedsetting/${doc}`, params,
            {
                headers: { Authorization: `Bearer ${token}` }
            }, {}
        ).then((res) => {
    ...
    return (
        <Fragment>
            <div
                ...
                <BreadCrumbsPage data={[{ title: "Edit Setting" }]} />
                        ...
                        <Form onSubmit={(e) => { castsubmit(e) }}>
                            <Row>
                                ...
                                <Col sm="2">
                                    ...
                                    <Input required name="purity" value={form.purity} placeholder="Purity" type="text" />
                                ...
                                <Col sm="2">
                                    ...
                                    <Input required value={form.tikliPieces}
                                ...
                                <Col sm="2">
                                    ...
                                    <Input
                                        name="tikliweight" value={form.tikliweight} onChange={(e) => { handleChange12(e) }}
                                    ...
                                    return (
                                        <div className="box row">
                                            <Col md={2}>
                                                ...
                                                {/* <select className="form-select" onChange={e => handleMulti2(e, i)}  name="stoneOutWeight"  >
                                                        <option value={x.stoneOutWeight}>{x.stoneOutWeight}</option>
                                                        {stpkts.map((data) => (
                                                            <option value={data.stoneOutWeight}>{data.stoneOutWeight}</option>
                                                        ))}
                                                    </select> */}
                                            ...
                                            <Col sm="2">
                                                ...
                                                <Input required name="item" value={x.item} placeholder="Item"
