...
const BreadCrumbs = () => {
  ...
  const caid = sessionStorage.getItem("pols1id")
  const caitem = sessionStorage.getItem("pols1item")
  const ordid = sessionStorage.getItem("ordobid3")
  ...
  const actiordrs = () => {
    ...
    const token = datas
    axios.post(`http://103.186.185.77:5023/omsanthoshjewellery/admin/polish1ststage/getpolish1ststagebyid`, params,
      {
  ...
  const activecust = () => {
    ...
    console.log(token)
    axios.put(`http://103.186.185.77:5023/omsanthoshjewellery/admin/polish1ststage/editpolish1ststage/${docid}`, params,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  return (
    <Fragment>
      <div
        ...
        <BreadCrumbsPage data={[{ title: "Polish 1st Stage Details" }]} />
        {/* <Nav /> */}
            ...
            <Form onSubmit={(e) => { handlesubmit(e) }}>
              <Row>
                <Col md={2}>
                  ...
                  <Input required  onChange={(e) => { handleChange(e) }} value={ordr.orderNo} type="text" placeholder="Sales Order Name">
                ...
                <Col sm="2">
                  ...
                  <Input required value={ordr.itemName} type="text" placeholder="Item">
                    {/* <option value="">Select</option>
                ...
                <Col sm="2">
                  ...
                  {/* <Select required isMulti options={options} /> */}
                  <Input required value={ordr.purity} type="text" placeholder="Purity">
                    {/* <option value="">Select</option>
                <option value="">18k</option>
                <option value="">22K</option>
                <option value="">24K</option> */}
                ...
                {/* <Col md={2}>
                  ...
                  <Input required name="receivedGold"  onChange={(e) => { handleChange(e) }} type="text" placeholder="Enter Wastage" className="form-control mb-1" />
                </Col> */}
              <Col md={2}>
                  <Label>
                    Balance<span className="text-danger">*</span>
                  </Label>
                  <Input required disabled value={forms01} type="text" placeholder="Loss" className="form-control mb-1" />
                </Col>
              </Row>
