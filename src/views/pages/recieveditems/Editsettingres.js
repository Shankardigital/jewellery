...
const BreadCrumbs = () => {
  ...
  const handleChanges1 = (e) => {
    ...
    const count2 = parseFloat(ordr.totalWeight) - (parseFloat(netweights.toFixed(3)))
  ...
  const handleChange2 = (e) => {
    ...
    console.log(count)
    setforms02(count.toFixed(3))
    const count2 = parseFloat(ordr.totalWeight) - (parseFloat(netwet))
    setforms01(count2.toFixed(3))
  }
  ...
  const actiordrs = () => {
    ...
    //   itemName: settitem
    // }
    axios.post(`http://103.186.185.77:5023/omsanthoshjewellery/admin/setting/receivedsettingobjid/${docsetid}`,
      {
      ...
      if (res.status === 200) {
        ...
        setordr(res.data.SettingData)
        setforms02(res.data.SettingData.wastage)
        setforms01(res.data.SettingData.balance)
        setnetwet(res.data.SettingData.netWeight)
  ...
  const updateset = () => {
    ...
    console.log(token)
    axios.put(`http://103.186.185.77:5023/omsanthoshjewellery/admin/setting/editreceivedsetting/${docsetid}`, params,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
            ...
            <Form onSubmit={(e) => { setsubmit(e) }}>
              <Row>
                ...
                <Col md={2}>
                  ...
                  <Input required value={ordr.totalWeight} type="text" placeholder="Enter Out Weight" className="form-control mb-1" />
                </Col>
                <Col md={2}>
                  <Label>
