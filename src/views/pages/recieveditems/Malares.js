...
//     const params = face
//     console.log(token)
//     axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/mala/filterWithDates", params,
//       {
...
//   }
  ...
  const activeitems = () => {
    const token = datas
    console.log(token)
    axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/mala/getallreceivedmala",
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  const custsearch = (e) => {
    ...
    const token = datas
    console.log(token)
    axios.post(`http://103.186.185.77:5023/omsanthoshjewellery/admin/mala/searchmalareceived?searchQuery=${e.target.value}`,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
...
//   sessionStorage.setItem("malaid", data._id)
//   sessionStorage.setItem("malaitem", data.itemName)
//   sessionStorage.setItem("ordobid7", data.orderId)
//   navigate("/Stage12")
// }
const getonemmber1 = (data) => {
  sessionStorage.setItem("malaobjid", data._id)
  // sessionStorage.setItem("setitem", data.itemName)
  // sessionStorage.setItem("ordobid5", data.orderId)
  navigate("/editmalares")
}
...
const changePage = ({ selected }) => {
  ...
  return (
    <Fragment >
      ...
      <ExtensionsHeader title="Mala Department" />
...
{/* {show ? (
      ...
      <Card>
          <div >
          <Link to="/mala-details"> <Button className="m-1" color="primary">
              <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i>  Back
              </Button></Link>

            {/* <Link to="/malares"> <Button className="m-1" color="warning">
              <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> Received
              </Button></Link> */}
