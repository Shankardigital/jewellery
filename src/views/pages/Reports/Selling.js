...
const Costing = () => {
    ...
    const handleChange = (e) => {
        ...
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/employeereport/customerorderreport/getsellingfinish", params,
            {
    ...
    return (
        <Fragment>
            <div
                ...
                <Breadcrumbs title='Selling Details' data={[{ title: 'Selling Details' }]} />
                                    ...
                                    <Table size='sm' id='empTable' responsive bordered hover>
                                        <thead>
                                            ...
                                            <tr className='text-center' >
                                                <td colSpan="20" className="text-danger"> Selling Detailed Summary</td>
                                            </tr>
