...
const Sngsetting = () => {
    ...
    const profiledet = () => {
        ...
        console.log(token)
        const purity = "18"
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/employeereport/bandiniReport/getallbandiniempreport", { purity },
            {
            ...
            if (res.status === 200) {
                ...
                setempl(res.data.bandiniArry)
                setempltot(res.data.bandiniArrTotal)
            }
    ...
    const navigatedata = (data) => {
        sessionStorage.setItem("bandrepid", data.employeeId)
        sessionStorage.setItem("bandrepprt", data.percentage)
        navigate("/bandini")
    }
    ...
    return (
        <Fragment>
            <div
                ...
                <Breadcrumbs title='Bandini karigars' data={[{ title: 'Bandini karigars' }]} />
                <Row>
                                    ...
                                    <Table responsive bordered hover id='empTable'>
                                        <thead>
                                            ...
                                            <tr className='text-center' >
                                                <td colSpan="5" className="text-danger">Bandini Karigars</td>
                                            </tr>
                                            <tr className='text-center'>
                                         ...
                                         <Link to="/employee-wise"> <Button size='sm' outline color='warning'>
                                          <i class="fa fa-eye" aria-hidden="true"></i> view
                                            ...
                                            <tr className='text-danger'>
                                                ...
                                                <td >
                                                    {empltot.bandiniTotalWt}
                                                </td>
                                                <td >
                                                </td>
                                                <td>
                                                    {empltot.bandiniFineWt}
                                                </td>
                                            </tr>
                                        </tbody>
