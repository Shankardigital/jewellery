...
const Sngsetting = () => {
    ...
    const profiledet = () => {
        ...
        console.log(token)
        const purity = "18"
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/employeereport/malaReport/getallmalaempreport", { purity },
            {
            ...
            if (res.status === 200) {
                ...
                setempl(res.data.malaArry)
                setempltot(res.data.malaArrTotal)
            }
    ...
    const navigatedata = (data) => {
        sessionStorage.setItem("malarepid", data.employeeId)
        sessionStorage.setItem("malarepprt", data.percentage)
        navigate("/sng-mala")
    }
    ...
    return (
        <Fragment>
            <div
                ...
                <Breadcrumbs title='Mala karigars' data={[{ title: 'Mala karigars' }]} />
                <Row>
                                    ...
                                    <Table responsive bordered hover id='empTable'>
                                        <thead>
                                            ...
                                            <tr className='text-center' >
                                                <td colSpan="5" className="text-danger">Mala Karigars</td>
                                            </tr>
                                            <tr className='text-center'>
