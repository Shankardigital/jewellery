...
const Sngsetting = () => {
    ...
    const profiledet = () => {
        ...
        console.log(token)
        const purity = "18"
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/employeereport/settingReport/getallsettingempreport", { purity },
            {
            ...
            if (res.status === 200) {
                ...
                setempl(res.data.settingArry)
                setempltot(res.data.settingArrTotal)
            }
    ...
    const navigatedata = (data) => {
        sessionStorage.setItem("settrepid", data.employeeId)
        sessionStorage.setItem("settrepprt", data.percentage)
        navigate("/setting")
    }
    ...
    return (
        <Fragment>
            <div
                ...
                <Breadcrumbs title='Setting karigars' data={[{ title: 'Setting karigars' }]} />
                <Row>
                                ...
                                <Table responsive bordered hover id='empTable'>
                                    <thead>
                                        ...
                                        <tr className='text-center' >
                                            <td colSpan="5" className="text-danger">Setting Karigars</td>
                                        </tr>
                                        <tr className='text-center'>
                                    ...
                                    <tbody className='text-center'>
                                        ...
                                        <tr className='text-danger'>
                                            ...
                                            <td >
                                                {empltot.settingTotalWt}
                                            </td>
                                            <td >
                                            </td>
                                            <td>
                                                {empltot.settingFineWt}
                                            </td>
                                        </tr>
