...
const Settings = () => {
    ...
    const docid = sessionStorage.getItem("settrepid")
    const purity = sessionStorage.getItem("settrepprt")
    const profiledet = () => {
        const token = datas
        console.log(token)
        const params = {
        ...
        axios.post("http://103.186.185.77:5023/omsanthoshjewellery/employeereport/settingReport/empwisesetting", params,
            {
            ...
            if (res.status === 200) {
                ...
                setempl(res.data.finalDatasettingEmp)
                setempl1(res.data.settingTotals)
            }
            ...
            <div
                ...
                <Row>
                    <div>
                        ...
                        <Link to="/sng-setting" style={{ float: "right" }} > <Button className='m-1' color='info'> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</Button></Link>
                    </div>
