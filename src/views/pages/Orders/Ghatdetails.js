...
const Casting = () => {
  ...
  const actiordrs = () => {
    const token = datas
    console.log(token)
    axios.post("http://103.186.185.77:5023/omsanthoshjewellery/admin/ghatdetails/getallpendingghatdetails",
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  const custsearch = (e) => {
    ...
    const token = datas
    console.log(token)
    axios.post(`http://103.186.185.77:5023/omsanthoshjewellery/admin/ghatdetails/getghatdetailsbysearch?searchQuery=${e.target.value}`,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
  ...
  const Addcasting = () => {
    ...
    const params = {
      ...
      issuedWeight: forms1.issuedWeight
    }
    console.log(token)
    axios.put(`http://103.186.185.77:5023/omsanthoshjewellery/admin/ghatdetails/editghatissued/${docsid}`, params,
      {
        headers: { Authorization: `Bearer ${token}` }
      }, {}
    ).then((res) => {
          ...
          <Card>
            <div >
              ...
              {access.orderEdit === true || adrole === "admin" ? (
                <Link to="/ghatres"> <Button className="m-1" color="warning">
            ...
            <Form onSubmit={(e) => { handleSubmit(e) }}>
              <Row className="mb-1">
                ...
                <Col className="mt-1" sm="12">
                  ...
                  {/* <select className="form-select" required onChange={(e) => handleChange(e)} name="itemId">
                ...
                <Col className="mt-1" sm="12">
                  ...
                  <Input onChange={(e) => handleChange(e)} value={forms1.issuedWeight} name="issuedWeight" type="text" placeholder="Enter Gold Weight" />
                </Col>
