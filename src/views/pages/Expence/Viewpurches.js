    ...
    return (
        <Fragment>
            <div
                ...
                <Breadcrumbs title='Purchase Details' data={[{ title: 'Purchase Details' }]} />
                <Row>
                    <div >
                        <Link to="/purches"> <Button style={{ float: "right" }} className='m-1' color='info'> <i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i> Back</Button></Link>
                    </div>
                    <Col sm='12'>
                        <Card>
                            <div>
